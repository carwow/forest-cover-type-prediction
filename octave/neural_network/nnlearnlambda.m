...
for i=1:numel(lambdas)
  lambda = lambdas(i);
  [Theta1, Theta2, cost] = nntrain(input_layer_size, hidden_layer_size, num_labels, X_train, y_train, lambda, initial_nn_params, max_iter);
  errors(i) = nncalculateerror(Theta1, Theta2, X_val, y_val);
end
